...
## demo 编写
特别要注意的是在跨域的时候我们需要在客户端的请求配置中设置`xhr.withCredentials: true`,在服务端设置`'Access-Control-Allow-Credentials': true`,
...
至此我们的 `withCredentials` feature 开发完毕，后面我们来实现 axios 对 XSRF的防御功能。
